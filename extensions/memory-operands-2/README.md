...
(the "full immediate" operand modes) this opcode corresponds to `READCR`, not `LEA`. Similarly, the specific case of `MM=01, ABM.regB=00x` also corresponds to `READCR` instead of `LEA`.
