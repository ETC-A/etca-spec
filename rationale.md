...
```
[addi r,1]; [slo r,imm[13:10]] if bit 16 is to be set but bit 15 is not
[addi r,imm[14:10]] if bits 16 and 15 are both to be set
[slo  r,imm[14:10]] if bit 16 is not to be set
```
